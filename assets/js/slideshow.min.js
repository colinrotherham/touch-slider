...
*/
	...
	"block");if(b.classMarkers){r=$("<div />").addClass(b.classMarkers).on("click touchend","button",y);for(e=d.length;e--;)r.prepend($("<button>"+(e+1)+"</button>"));z=r.find("button");c.append(r)}K();y();P();H=setTimeout(t,b.delay)}};a.start=t;a.stop=u;a.next=I;a.prev=J;a.transition=s;a.getTransitionX=x};