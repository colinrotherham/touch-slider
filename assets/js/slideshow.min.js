...
*/
	...
	var CRD=CRD||{};
	CRD.Slideshow=function(ea,L,M){function N(a){$.each(a,function(a,b){c[a]=b});O="undefined"!==typeof c.isTouch?!!c.isTouch:"ontouchstart"in window||navigator.msPointerEnabled||window.DocumentTouch&&document instanceof DocumentTouch}function P(a){C&&clearTimeout(C);C=s(function(){var d,e,f;b.viewportWidth=Math.floor(document.documentElement.clientWidth);g&&g.length&&c.breakpoints&&($.each(c.breakpoints,function(a,c){c.range&&(d=c.range[0],e=c.range[1],b.viewportWidth>=d&&(!e||b.viewportWidth<=e)&&(f=
	a))}),"undefined"!==typeof f&&(a||(b.breakpoint=f),a&&c.breakpoints[f].callback&&b.breakpoint!==f&&(b.breakpoint=f,c.breakpoints[f].callback())))},a?300:0)}function Q(a){D&&clearTimeout(D);D=s(function(){b.width=g.outerWidth()},a?300:0)}function x(){c.isManual||(R=s(function(){l()},c.interval))}function y(){clearTimeout(S);clearTimeout(R)}function s(a,b){return setTimeout(a,b||0)}function T(a){l.call(this,a,{isPrev:!1})}function U(a){l.call(this,a,{isPrev:!0})}function l(a,d){var e=b.index,f=c.isCarousel?
