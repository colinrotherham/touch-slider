...
*/
	...
	display:c.display}).attr("tabindex","-1").data("x",g);u(c.canLoop?B:b.index)}function aa(){var a,e;function d(d){var g=d.originalEvent,w=g.touches&&g.touches[0]||g;D||1<w.length||g.scale&&1!==g.scale||(a=(w.pageX||w.screenX)-l.x,e=(w.pageY||w.screenY)-l.y,"undefined"===typeof r&&(r=!!(r||Math.abs(a)<Math.abs(e))),r||(d.preventDefault(),y(),q=0<a,D=p=!0,!c.canLoop&&U()&&(a/=Math.abs(a)/b.width+1),u(null,null,null,a/b.width*(100/f))))}function g(){if(!r){var e=+new Date-l.time,f=Math.abs(a),e=250>e&&
	20<f||f>b.width/3;p=!1;e&&!U()?s.call(this,event,{isPrev:q}):0<f&&u(null,c.time)}k.off(m,d);k.off(n,g)}function h(a){H&&clearTimeout(H);H=setTimeout(function(){b.width=k.outerWidth()},a?300:0)}var l,m="touchmove pointermove MSPointerMove",n="touchend touchleave touchcancel MSPointerUp MSPointerOut MSPointerCancel pointerup pointerleave pointercancel";c.isCarousel=!0;k.on("touchstart pointerdown MSPointerDown",function(b){var c=v||t&&t.add(v),f=b.originalEvent,f=f.touches&&f.touches[0]||f;c.has(b.target).length||
