...
*/
	...
	t,c={next:"button.next",previous:"button.previous",classStrip:"strip",classSlide:"slide",classActive:"sticky",classMarkers:"markers",classDisabled:"disabled",delay:3E3,interval:5E3,time:600,canLoop:!0,isManual:!0,isCarousel:!0},e,d,n,p,x,C,B,y,w,j,E,J=document.body.style,z=q.length;z--;)"string"===typeof J[q[z]+"Transition"]&&(m=q[z]);E=!!m;var H="ontouchstart"in window||window.DocumentTouch&&document instanceof DocumentTouch;$.each(I,function(a,d){c[a]=d});a.element=e;a.strip=n;a.slides=d;a.init=
	function(){e=$(c.slideshow);d=e.find("."+c.classSlide);n=e.find("."+c.classStrip);if(e.length&&!(2>d.length)){t=n[0].style;a.slide=d.filter("."+c.classActive);a.number=d.index(a.slide)+1;a.slide.length||(a.number=1,a.slide=d.eq(a.number-1).addClass(c.classActive));H&&(c.isCarousel=!0);n.width(100*d.length+"%");d.width(100/d.length+"%");for(var b=d.length,j;b--;)j=u(b,!0)+"%",d.eq(b).css({left:j,display:"block"}).attr("tabindex","-1");s(0);e.mouseenter(v).mouseleave(r);if(H){var f,g,m,l,k,b="."+c.classStrip;
	e.on("touchstart",b,function(a){a=a.originalEvent.touches[0];m=a.pageX;l=a.pageY;k=g=f=void 0});e.on("touchmove",b,function(b){var c=b.originalEvent,e=c.touches[0];1<e.length||c.scale&&1!==c.scale||(f=e.pageX-m,g=e.pageY-l,"undefined"===typeof k&&(k=!!(k||Math.abs(f)<Math.abs(g))),k||b.preventDefault(),s(0,function(){},f/a.width*(100/d.length)))});e.on("touchend touchcancel",b,function(){k||h()});e.on("click",b,function(a){k||a.preventDefault()});$(window).resize(G)}else d.click(h),a.next=e.find(c.next).on("click",
